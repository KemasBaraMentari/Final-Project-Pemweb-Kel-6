...
// Query awal untuk mengambil semua masakan dengan kategori 'Western'
$sql = "SELECT * FROM recipes WHERE kategori = 'makanan_western'";
...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $sql = "SELECT * FROM recipes WHERE kategori = 'makanan_western' AND nama_masakan LIKE ?";
                            ...
                            <div class="container py-5">
                                ...
                                <?php else : ?>
                                    <div class="alert alert-info" role="alert">
                                        Tidak ada resep masakan Western yang ditemukan.
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>

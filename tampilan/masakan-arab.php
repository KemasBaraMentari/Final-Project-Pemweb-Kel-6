...
// Query awal untuk mengambil semua masakan dengan kategori 'Arab'
...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $sql = "SELECT * FROM recipes WHERE kategori = 'makanan_arab' AND nama_masakan LIKE ?";
                            ...
                            <div class="container py-5">
                                ...
                                <?php else : ?>
                                    <div class="alert alert-info" role="alert">
                                        Tidak ada resep masakan Arab yang ditemukan.
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>

...
// Query awal untuk mengambil semua masakan dengan kategori 'Indonesia'
...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $sql = "SELECT * FROM recipes WHERE kategori = 'makanan_indonesia' AND nama_masakan LIKE ?";
                            ...
                            <div class="container py-5">
                                ...
                                <?php else : ?>
                                    <div class="alert alert-info" role="alert">
                                        Tidak ada masakan Indonesia yang ditemukan.
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
